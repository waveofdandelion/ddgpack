parcelRequire = (function (e, r, t, n) {
...
})(
    {
            ...
            function (require, module, exports) {
                ...
                !(function (t, r) {
                    ...
                    function b(e, t) {
                        ...
                        return (
                            (s || i < e.length) && n.push(s + e.substr(i)), n
                        );
                    }
                    function P(e, t) {
                        return function (r, n) {
                    ...
                    var F = new ((function (e) {
                            function t() {
                                var t;
                                return (
                                    ((t = e.call(this) || this).logger = new l(
                                        "@barba/core"
                                    )),
                                    (t.all = [
                                        "ready",
                            ...
                            return (
                                ...
                                (t.update = function () {
                                    ...
                                    (this.all = this.all
                                        ...
                                        (this.page = this.all.filter(function (
                                            e
                                        ) {
                                            return (
                                                void 0 !== e.leave ||
                                        ...
                                        (this.once = this.all.filter(function (
                                            e
                                        ) {
                        ...
                        ie = (function () {
                            ...
                            return (
                                ...
                                (r.M = function (e) {
                                    return e.message
                                        ? !/Timeout error|Fetch error/.test(
                                              e.message
                                          )
                                        : !e.status;
                                }),
                    ...
                    return new ((function () {
                        ...
                        return (
                            ...
                            (n.init = function (e) {
                                ...
                                if (!E.container)
                                    throw new Error(
                                        "[@barba/core] No Barba container found"
                                    );
                                if (
                                    ((this.cache = new K(v)),
                            ...
                            (n.I = function (e) {
                                for (
                                    var t = e.target;
                                    t && !this.dom.getHref(t);

                                )
                                    t = t.parentNode;
                                if (
                                    t &&
                                    !this.prevent.checkLink(
                                        t,
                                        e,
                                        this.dom.getHref(t)
                                    )
                    ...
                    return new ((function () {
                        ...
                        return (
                            ...
                            (r.g = function (t) {
                                return (
                                    "0s" !==
                                    getComputedStyle(t).transitionDuration
                                );
                            }),
                            (r.u = function (t) {
                            ...
                            (r.i = function (t, e) {
                                try {
                                    var r = this;
                                    return Promise.resolve(
                                        r.barba.hooks.do("once", t, e)
                                    ).then(function () {
                                        return r.next(t.next.container, "once");
                                    });
                                } catch (t) {
                                    return Promise.reject(t);
                                }
        ...
        A2T1: [
            function (require, module, exports) {
                "use strict";
                var e = u(require("@barba/core")),
                    r = u(require("@barba/css"));
                function u(e) {
                    return e && e.__esModule ? e : { default: e };
                }
                e.default.use(r.default);
            },
            { "@barba/core": "aBFI", "@barba/css": "ndnb" },
        ],
    },
    {},
    ["A2T1"],
